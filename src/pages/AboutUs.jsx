...
const AboutPage = () => {
    return (
        <>
            <main class="container mx-auto mt-20 py-10 px-4 sm:px-6 lg:px-8">

            {/* <!-- About Us Section --> */}
            <div class="bg-gray-800 text-white py-8">
                <div class="container mx-auto text-center">
                <h1 class="text-4xl font-bold">About Us</h1>
                <p class="text-lg mt-2">Welcome to Shri Ram Infrustructure - Where Your Dreams Become Reality</p>
                </div>
            </div>

            {/* <!-- Who We Are Section --> */}
            <section class="bg-white rounded-lg shadow-lg p-8 mb-12">
            <h2 class="text-2xl font-bold text-center text-gray-800">Who We Are</h2>
            ...
            <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
            <div class="bg-white p-6 rounded-lg shadow-md">
                <h3 class="text-xl font-semibold text-gray-800">Passion for Excellence</h3>
                <p class="text-gray-600 mt-2">
                We approach every project with enthusiasm, energy, and a commitment to quality that sets us apart.
                </p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-md">
                <h3 class="text-xl font-semibold text-gray-800">Client-First Approach</h3>
                <p class="text-gray-600 mt-2">
                Your dreams are our priority. We work closely with you to ensure every detail meets your expectations.
                </p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-md">
                <h3 class="text-xl font-semibold text-gray-800">Innovation & Fresh Ideas</h3>
                <p class="text-gray-600 mt-2">
            ...
            <div class="p-4 bg-gray-100 rounded-lg shadow-xl w-full text-center mx-auto mt-5">
            {/* <!-- Manager's Details --> */}
            <div class="mb-4">
                <h2 class="text-xl font-bold text-gray-800">Manager</h2>
                <p class="text-gray-600 font-semibold">Abhishek Kumar Vishwakarma</p>
                <p class="text-sm text-gray-500">Civil Engineer - Diploma, Architecture, B.Tech</p>
            </div>

            {/* <!-- Proprietor's Details --> */}
            <div>
                <h2 class="text-xl font-bold text-gray-800">Proprietor</h2>
                <p class="text-gray-600 font-semibold">Rohit Singh</p>
                <p class="text-sm text-gray-500">Civil Engineer - Diploma</p>
            </div>
            </div>
